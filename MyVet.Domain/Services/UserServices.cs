...
namespace MyVet.Domain.Services
{
    public class UserServices : IUserServices
    {
        ...
        {
            var users = _unitOfWork.RolUserRepository.GetAll(x=>x.UserEntity,
                x=>x.RolEntity);
            List<UserDto> listUsers = users.Select(x => new UserDto
            {
                Name = x.UserEntity.FullName,
        ...
        //            RolUserEntity rolUser = new RolUserEntity()
        //            {
        //                IdRol = RolUser.Administrador.GetHashCode(),
